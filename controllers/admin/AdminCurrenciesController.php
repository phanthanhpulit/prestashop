		...
		$this->fields_form = array(
			...
			'input' => array(
				...
				array(
					...
					'options' => array(
						'query' => array(
							array('key' => 1, 'name' => 'X0,000 ('.$this->l('Such as with Dollars').')'),
							array('key' => 2, 'name' => '0 000X ('.$this->l('Such as with Euros').')'),
							array('key' => 3, 'name' => 'X0.000'),
							array('key' => 4, 'name' => '0,000X'),
							array('key' => 5, 'name' => 'X0\'000') // Added for the switzerland currency
						),
						'name' => 'name',
						'id' => 'key'
					)
